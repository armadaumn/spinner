...
type TaskRequest struct {
	...
	Taskspec *TaskSpec `protobuf:"bytes,2,opt,name=taskspec,proto3" json:"taskspec,omitempty"`
}
...
var file_spincomm_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x22, 0x66, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x52, 0x65,
	...
	0x6d, 0x2e, 0x55, 0x55, 0x49, 0x44, 0x52, 0x06, 0x74, 0x61, 0x73, 0x6b, 0x49, 0x64, 0x12, 0x2e,
	0x0a, 0x08, 0x74, 0x61, 0x73, 0x6b, 0x73, 0x70, 0x65, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
...
var file_spincomm_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_spincomm_proto_goTypes = []interface{}{
	...
	(*ResourceStatus)(nil),      // 5: spincomm.ResourceStatus
	(*HostRC)(nil),              // 6: spincomm.HostRC
	(*ContainerStatus)(nil),     // 7: spincomm.ContainerStatus
	(*NodeInfo)(nil),            // 8: spincomm.NodeInfo
	(*TaskSpec)(nil),            // 9: spincomm.TaskSpec
	(*ResourceRequirement)(nil), // 10: spincomm.ResourceRequirement
	(*PingResp)(nil),            // 11: spincomm.PingResp
	nil,                         // 12: spincomm.NodeInfo.HostResourceEntry
	nil,                         // 13: spincomm.TaskSpec.ResourceMapEntry
	nil,                         // 14: spincomm.TaskSpec.PortsEntry
}
var file_spincomm_proto_depIdxs = []int32{
	...
	9,  // 2: spincomm.TaskRequest.taskspec:type_name -> spincomm.TaskSpec
	0,  // 3: spincomm.TaskLog.task_id:type_name -> spincomm.UUID
	5,  // 4: spincomm.HostRC.CPU:type_name -> spincomm.ResourceStatus
	5,  // 5: spincomm.HostRC.Memory:type_name -> spincomm.ResourceStatus
	0,  // 6: spincomm.NodeInfo.captain_id:type_name -> spincomm.UUID
	12, // 7: spincomm.NodeInfo.host_resource:type_name -> spincomm.NodeInfo.HostResourceEntry
	7,  // 8: spincomm.NodeInfo.container_status:type_name -> spincomm.ContainerStatus
	13, // 9: spincomm.TaskSpec.ResourceMap:type_name -> spincomm.TaskSpec.ResourceMapEntry
	14, // 10: spincomm.TaskSpec.Ports:type_name -> spincomm.TaskSpec.PortsEntry
	5,  // 11: spincomm.NodeInfo.HostResourceEntry.value:type_name -> spincomm.ResourceStatus
	10, // 12: spincomm.TaskSpec.ResourceMapEntry.value:type_name -> spincomm.ResourceRequirement
	1,  // 13: spincomm.Spinner.Attach:input_type -> spincomm.JoinRequest
	3,  // 14: spincomm.Spinner.Run:input_type -> spincomm.TaskLog
	2,  // 15: spincomm.Spinner.Request:input_type -> spincomm.TaskRequest
	8,  // 16: spincomm.Spinner.Update:input_type -> spincomm.NodeInfo
	2,  // 17: spincomm.Spinner.Attach:output_type -> spincomm.TaskRequest
	4,  // 18: spincomm.Spinner.Run:output_type -> spincomm.TaskCompletion
	3,  // 19: spincomm.Spinner.Request:output_type -> spincomm.TaskLog
	11, // 20: spincomm.Spinner.Update:output_type -> spincomm.PingResp
